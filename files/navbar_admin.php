      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
          ...
          <li class="nav-item dropdown" style="list-style:None;">
              ...
              <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink"
                style="background-color:#1E4362">
                <li><a class="dropdown-item" href="http://localhost/studentSpace/notice/display.php">Notices</a></li>
                <li><a class="dropdown-item" href="http://localhost/studentSpace/contact/contact_list.php">Contacts</a></li>
                
                <li class="nav-item dropdown dropend">
                  <a class="nav-link dropdown-toggle" style=" color:#fff" href="#" id="multilevelDropdownMenu1"
                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Time Table
                  </a>
